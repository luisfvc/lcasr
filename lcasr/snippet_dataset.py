...
from lcasr.utils.utils import load_yaml
from lcasr.msmd_dataset import load_msmd_piece
...
if __name__ == '__main__':
    ...
    prepared_msmd_path = '/home/luis/data/prepared_msmd'
    split = load_yaml('splits/msmd_split.yaml')['test']

    dataset = load_msmd_dataset(prepared_msmd_path, split, parser.parse_args())
    n_test = 2_000
